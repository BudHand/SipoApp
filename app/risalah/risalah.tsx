...
export default function RisalahScreen() {
  ...
  // Fetch risalah
  const fetchRisalah = async (isRefresh = false) => {
    try {
      let url = "/risalahs";
      ...
      console.error("Error fetching risalah:", error);
  ...
  return (
    <SafeAreaView style={stylesIndex.container} edges={["top", "bottom"]}>
      {/* Header */}
        ...
        {isEmpty ? (
          ...
          <View style={styles.emptyStateContainer}>
            ...
            <Text style={[Fonts.paragraphRegularSmall, styles.emptyMessage]}>
              {approval === "1"
                ? "Tidak ada risalah yang menunggu\npersetujuan Anda saat ini"
                : status || divisi
                ? "Tidak ada risalah yang sesuai\ndengan filter yang dipilih"
