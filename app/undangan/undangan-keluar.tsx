...
export default function UndanganKeluarScreen() {
  ...
  const fetchUndangans = useCallback(async () => {
    try {
      ...
      console.error("Gagal ambil undangan keluar:", err);
      Alert.alert("Error", "Gagal memuat undangan keluar. Silakan coba lagi.");
    } finally {
      setLoading(false);
      setRefreshing(false);
    }
    ...
    <>
      {approval !== "1" && (
        <MemoFilterModal
          ...
          title="Filter Undangan Keluar"
          subtitle="Saring undangan keluar berdasarkan status dan kode bagian"
          ...
          <View style={styles.headerTop}>
            ...
            <View style={styles.headerTitleWrap}>
              ...
              <Text style={[styles.headerSubtitle, { color: C.textSecondary }]}>
                Daftar undangan rapat yang dikirim
              </Text>
            </View>
              ...
              <View style={{ flex: 1 }}>
                ...
                >
                  {hasFilter
                    ...
                    : "Semua undangan keluar yang tersedia"}
                </Text>
              </View>
            </View>
          ...
          {isEmpty ? (
            <View style={styles.emptyStateContainer}>
              ...
              <Text style={[styles.emptyMessage, { color: C.textSecondary }]}>
                {approval === "1"
                  ? "Tidak ada undangan keluar yang menunggu persetujuan Anda saat ini."
                  : hasFilter
                    ? "Tidak ada undangan keluar yang sesuai dengan filter yang dipilih."
                    : "Anda belum memiliki undangan keluar."}
              </Text>
                  ...
                  onPress={() =>
                    router.push({
                      ...
                      params: {
                        ...
                        jenis: "keluar",
                        source: "undangan-keluar",
                        from: "undangan-keluar",
                      },
                    })
                  }
                  style={[
